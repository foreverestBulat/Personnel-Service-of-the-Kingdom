# Generated by Django 5.1.6 on 2025-02-09 18:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('questions', models.ManyToManyField(related_name='questions', to='app.question', verbose_name='Список вопросов')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answers', models.JSONField(verbose_name='Выбранные ответы')),
                ('status', models.CharField(choices=[('Enrolled', 'Зачислен'), ('Not enrolled', 'Не зачислен')], null=True, verbose_name='Статус зачисления')),
                ('solved_test', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.candidatetesttrial', verbose_name='Решенное тестовое задание')),
            ],
        ),
        migrations.CreateModel(
            name='Subject',
            fields=[
                ...
                ('solved_test_case', models.ManyToManyField(to='app.solvedtestcase', verbose_name='Решенные тестовые испытания')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, verbose_name='Имя')),
                ('kingdom', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.kingdom', verbose_name='Королевство')),
                ('subjects', models.ManyToManyField(default=None, null=True, to='app.subject', verbose_name='Подданные')),
            ],
            options={
                'verbose_name': 'Король',
